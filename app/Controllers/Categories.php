...
use CodeIgniter\RESTful\ResourceController; //menginclude Resource Controller

class Categories extends ResourceController{
	protected $format = 'json'; // menentukan jenis output yang akan diinginkan
	protected $modelName = 'App\Models\Category_model'; // untuk memanggil model
